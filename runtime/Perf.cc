...
TestInfo tests[] = {
    ...
    {"manualCopyCached1", manualCopyCached1,
     "for-loop copy 1 byte with hot/fixed dst and backend"},
    {"manualCopyCached10", manualCopyCached10,
     "for-loop copy 10 bytes with hot/fixed dst and backend"},
    {"memcpyCached1", memcpyCached1,
     "memcpy 1 bytes with hot/fixed dst and backend"},
    {"memcpyCached100", memcpyCached100,
     "memcpy 100 bytes with hot/fixed dst and backend"},
    {"memcpyCached1000", memcpyCached1000,
     "memcpy 1000 bytes with hot/fixed dst and backend"},
    {"memcpyCachedDst100", memcpyCachedDst100,
     "memcpy 100 bytes with hot/fixed dst and cold backend"},
    {"memcpyCachedDst1000", memcpyCachedDst1000,
     "memcpy 1000 bytes with hot/fixed dst and cold backend"},
    {"memcpyCold100", memcpyCold100,
     "memcpy 100 bytes with cold dst and backend"},
    {"memcpyCold1000", memcpyCold1000,
     "memcpy 1000 bytes with cold dst and backend"},
